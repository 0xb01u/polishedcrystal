...
MewFrontpic: INCBIN "gfx/pokemon/mew_plain/front.animated.2bpp.lz"
MewBackpic:  INCBIN "gfx/pokemon/mew_plain/back.2bpp.lz"
...
MewArmoredFrontpic: INCBIN "gfx/pokemon/mewtwo_armored/front.animated.2bpp.lz"
MewArmoredBackpic:  INCBIN "gfx/pokemon/mewtwo_armored/back.2bpp.lz"
