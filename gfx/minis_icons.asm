...
MewArmoredMini::        INCBIN "gfx/minis/mew_armored.2bpp.lz"
MewArmoredMiniMask::    INCBIN "gfx/minis/mew_armored_mask.1bpp.lz"
MewArmoredIcon::        INCBIN "gfx/icons/mew_armored.2bpp.lz"
